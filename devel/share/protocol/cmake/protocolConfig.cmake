...
if("TRUE" STREQUAL "TRUE")
  set(protocol_SOURCE_PREFIX /home/yyy/Desktop/dbz/force_master_ws/src/protocol)
  set(protocol_DEVEL_PREFIX /home/yyy/Desktop/dbz/force_master_ws/devel)
  set(protocol_INSTALL_PREFIX "")
  set(protocol_PREFIX ${protocol_DEVEL_PREFIX})
else()
  set(protocol_SOURCE_PREFIX "")
  set(protocol_DEVEL_PREFIX "")
  set(protocol_INSTALL_PREFIX /home/yyy/Desktop/dbz/force_master_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'protocol' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yyy/Desktop/dbz/force_master_ws/src/protocol/${idir}'.  ${_report}")
    endif()
    _list_append_unique(protocol_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "protocol")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT protocol_NUM_DUMMY_TARGETS)
      set(protocol_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::protocol::wrapped-linker-option${protocol_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR protocol_NUM_DUMMY_TARGETS "${protocol_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::protocol::wrapped-linker-option${protocol_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND protocol_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(protocol_EXPORTED_TARGETS ${${protocol_dep}_EXPORTED_TARGETS})
endforeach()
